...
namespace Regulacja_v2
{
    ...
    class Piec2 : Piec
    {
        public Piec2(string file, int numer, int program) : base(file, numer, program)
        { }
        public Piec2(string file, int numer) : base(file, numer)
        { }
        public void PiecWatek()
        {
            ...
            Zakoncz();
            Static.p2s = false;                                                     //ustawienie interfejsu
            return;                                                                 //wyjscie z watku
        }
        /// <summary>
