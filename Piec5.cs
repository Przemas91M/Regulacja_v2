...
namespace Regulacja_v2
{
    ...
    class Piec5 : Piec
    {
        public Piec5(string file, int numer, int program) : base(file, numer, program)
        { }
        public Piec5(string file, int numer) : base(file, numer)
        { }
        public void PiecWatek()
        {
            ...
            Zakoncz();
            Static.p5s = false;                                                     //ustawienie interfejsu
            return;                                                                 //wyjscie z watku
        }
        /// <summary>
