...
namespace Regulacja_v2
{
    ...
    class Piec4 : Piec
    {
        public Piec4(string file, int numer, int program) : base(file, numer, program)
        { }
        public Piec4(string file, int numer) : base(file, numer)
        { }
        public void PiecWatek()
        {
            ...
            Zakoncz();
            Static.p4s = false;                                                     //ustawienie interfejsu
            return;                                                                 //wyjscie z watku
        }
        /// <summary>
