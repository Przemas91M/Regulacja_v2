...
namespace Regulacja_v2
{
    ...
    class Piec1 : Piec
    {
        public Piec1(string file, int numer, int program ) : base(file, numer, program)
        { }
        public Piec1(string file, int numer) : base(file, numer)
        { }
        public void PiecWatek()
        {
            ...
            Zakoncz();
            Static.p1s = false;                                                     //ustawienie interfejsu
            return;                                                                 //wyjscie z watku
        }
        /// <summary>
